...
export async function getShopifyAccessToken() {
  if (cachedShopifyToken && Date.now() < cachedShopifyTokenExpiresAt - 60_000) {
  ...
  if (CFG.dryRun) {
    ...
    return {
      product: {
        ...
        variants: [{ id: "DRY_RUN_VARIANT_ID", inventory_item_id: "DRY_RUN_INVENTORY_ITEM_ID" }]
      }
    };
  }
  return shopifyRequest("/products.json", {
    method: "POST",
