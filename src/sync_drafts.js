import {
  ...
  createShopifyDraftProduct, updateInventoryItemCost, shopifyAdminProductUrl,
...
async function processRecord(record) {
  ...
  logger("info", "Created Shopify draft and updated Airtable", { sku, productId: product.id, draftUrl });
...
main().catch(err => { logger("error", "sync-drafts failed", err.message); process.exit(1); });
